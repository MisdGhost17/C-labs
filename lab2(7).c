...
int main(){
    ...
    char input[300]; //массив для строки
...
void transform_string(const char *input) {
    char words[30][11]; //двусвязный массив для слов (30 слов по 10 + \0 символов)
    int word_count = 0; //переменная для количества слов

    // Копируем строку, заменяя точку на \0(символ означающий конец строки)
    char str[300]; // создаем массив из 300 элементов так как 30 слов * 10 букв в каждом
